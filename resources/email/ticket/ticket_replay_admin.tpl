                    ...
                    <td align="center" valign="top" style="background: #ffffff;">
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" width="88%"
                            ...
                            <tr>
                                <td align="left" valign="top">
                                    ...
                                    <font class="mob_title1" face="'Nunito', sans-serif" color="#1a1a1a"
                                          style="font-size: 52px; line-height: 55px; font-weight: 300; letter-spacing: -1.5px;">
                                        <a href="{$config['baseUrl']}" style="text-decoration:none"><span
                                                    class="mob_title1"
                                                    style="font-family: 'Nunito', Arial, Tahoma, Geneva, sans-serif; color: #6777ef; font-size: 48px; line-height: 55px; font-weight: 700; letter-spacing: -1.5px;">{$config['appName']}</span></a>
                                    </font>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" width="88%"
                            ...
                            <tr>
                                <td align="left" valign="top">
                                                    ...
                                                    <table class="mob_card" cellpadding="0" cellspacing="0" border="0">
                                                        ...
                                                        <tr>
                                                            <td align="left" valign="top">
                                                                ...
                                                                <div style="height: 22px; line-height: 22px; font-size: 20px;">
                                                                    &nbsp;
                                                                </div>
                                                                <font face="'Nunito', sans-serif" color="#ff9800"
                                                                ...
                                                                <font face="'Nunito', sans-serif" color="#101010"
                                    ...
                                    <table class="mob_btn" cellpadding="0" cellspacing="0" border="0"
                                           style="background: #6777ef; border-radius: 200px;">
                                        <tr>
                                            <td align="center" valign="top">
                          <span style="display: block; border: 1px solid #6777ef; border-radius: 200px; padding: 8px 24px 6px 24px;; font-family: 'Nunito', Arial, Verdana, Tahoma, Geneva, sans-serif; color: #ffffff; font-size: 20px; line-height: 30px; text-decoration: none; white-space: nowrap; font-weight: 600;">
                            <font face="'Nunito', sans-serif" color="#ffffff"
                                  style="font-size: 20px; line-height: 30px; text-decoration: none; white-space: nowrap; font-weight: 600;">
                              <a href="{$ticket_url}"
                                 style="font-family: 'Nunito', Arial, Verdana, Tahoma, Geneva, sans-serif; color: #ffffff; font-size: 20px; line-height: 30px; text-decoration: none; white-space: nowrap; font-weight: 600;">查看工单</a>
                            </font>
                          </span>
                                            </td>
                                        </tr>
                                            ...
                                            <td align="center" valign="top">
                                                ...
                                                <font face="'Nunito', sans-serif" color="#1a1a1a"
                                                    ...
                                                    <span style="font-family: 'Nunito', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 17px; line-height: 20px;"><a
                                                                href="{$config['baseUrl']}" target="_blank"
                                                                style="font-family: 'Nunito', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 17px; line-height: 20px; text-decoration: none;">访问官网</a> &nbsp;&nbsp;|&nbsp;&nbsp; <a
                                                                href="{$config['baseUrl']}/user/" target="_blank"
                                                                style="font-family: 'Nunito', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 17px; line-height: 20px; text-decoration: none;">用户中心</a></span>
                                                </font>
                                                <div style="height: 35px; line-height: 35px; font-size: 33px;">&nbsp;
                                                </div>
                                            </td>
