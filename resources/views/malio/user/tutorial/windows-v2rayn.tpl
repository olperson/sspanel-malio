                        ...
                        <div class="section-header-breadcrumb">
                            {if $malio_config['enable_windows_gaming_tutorial'] == true}
                                <div id="checkin-div" class="breadcrumb-item active">
                                    <a href="/user/tutorial?os=windows&client=netch"
                                       class="btn btn-icon icon-left btn-primary {if $malio_config['display_more_app_button'] == true}mr-2{/if}"><i
                                                class="fas fa-gamepad"></i> 游戏加速教程</a>
                                </div>
                            {/if}
                            {if $malio_config['display_more_app_button'] == true}
                                <div class="btn-group dropleft">
                                    ...
                                    <div class="dropdown-menu dropleft">
                                        <a class="dropdown-item has-icon" href="/user/tutorial?os=windows&client=ssr"><i
                                                    class="malio-ssr"></i>SSR</a>
                                    </div>
                                </div>
                            {/if}
                        </div>
                                            ...
                                            <div class="row">
                                                <div class="left-text col-xs-12 col-md-6 col-lg-6">
                                                    ...
                                                    <p class="text-muted" style="font-size: 13px">
                                                        ...
                                                        订阅导入不成功？<a href="#manual-import"
                                                                   class="text-muted "><u>试试手动导入</u> →</a></p>
                                                </div>
                                                <div class="right-pic col-xs-12 col-md-6 col-lg-6">
                                        ...
                                        <div class="row mt-2 mb-2">
                                            ...
                                            <div class="col-sm-6 col-xs-12 col-md-6 col-lg-6">
                                                ...
                                                <p class="mb-0 font-13">
                                                    访问 <a href="https://time.is" target="blank">https://time.is <i
                                                                class="fas fa-external-link-alt"></i></a>
                                                    ，确保你的电脑系统时间与标准时间的时间差不超过 1 分钟。
                                                </p>
                                            </div>
                                        </div>
                                    </div>
