                        ...
                        <div class="section-header-breadcrumb">
                            <div class="btn-group dropleft">
                                ...
                                <div class="dropdown-menu dropleft">
                                    <a class="dropdown-item has-icon" href="/user/tutorial?os=android&client=clash"><i
                                                class="malio-clash"></i>Clash</a>
                                    ...
                                    <ul class="steps">
                                        <li>
                                            <div class="row">
                                                <div class="left-text col-xs-12 col-md-6 col-lg-6">
                                                    ...
                                                    <p>下载 v2rayNG 客户端 。</p>
                                                    <a href="{$malio_config['download_v2rayng']}"
                                        ...
                                        <li>
                                            ...
                                            <div class="row">
                                                <div class="left-text col-xs-12 col-md-6 col-lg-6">
                                                    ...
                                                    <p>打开 V2rayNG 点击左上角的菜单图标打开侧边栏，随后点击
                                                        订阅设置。点击右上角的加号按钮，在新页面的备注中填写本站名称，地址输入框中粘贴订阅链接并点击右上角的 <i
                                                    ...
                                                    <a href="##"
                                                       ...
                                                       data-clipboard-text="{$subInfo['v2ray']}{if $malio_config['enable_sub_extend'] == true}&extend=1{/if}"><i
                                                                class="malio-v2rayng"></i> 复制 V2Ray 订阅链接</a>
                                                    <div class="right-pic col-xs-12 col-md-6 col-lg-6">
                                                        <div class="tutorial-pic">
                                                            <img src="https://i.loli.net/2019/11/24/XEqUaZQfWTcSLVP.png"
                                                                 alt>
                                                        </div>
                                                    </div>
                                                    <div class="right-pic col-xs-12 col-md-6 col-lg-6">
                                                        <div class="tutorial-pic">
                                                            ...
                                                            <img src="https://i.loli.net/2019/11/24/s1OX5xZEcTvY9kp.png"
                                                                 alt>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <li>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="right-pic col-xs-12 col-md-6 col-lg-6">
                                                    <div class="tutorial-pic">
                                                        <img src="https://i.loli.net/2019/11/24/Gdt8p25JwvLg6Sy.png"
                                                             alt>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <li>
                                            ...
                                            <div class="row">
                                                <div class="left-text col-xs-12 col-md-6 col-lg-6">
                                                    ...
                                                    <p class="text-muted" style="font-size: 13px">更新失败？<a
                                                                href="#manual-import" class="text-muted "
                                                                one-link-mark="yes"><u>试试手动导入</u> →</a></p>
                                                </div>
                                                <div class="right-pic col-xs-12 col-md-6 col-lg-6">
                                                    <div class="tutorial-pic"><img
                                                                src="https://i.loli.net/2019/11/24/txRZrAOT6zQ9vVp.png"
                                                                alt>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row mt-2 mb-2">
                                            ...
                                            <div class="col-sm-6 col-xs-12 col-md-6 col-lg-6" id="manual-import">
                                                ...
                                                <p class="mb-4 font-13">
                                                    点击 <a href="/user">用户中心</a>，在便捷导入模块，点击
                                                    批量复制vmess链接->APP右上角＋号->从剪切板导入。
                                                </p>
                                            </div>
