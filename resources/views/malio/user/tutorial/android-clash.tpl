                                ...
                                <div class="btn-group dropleft">
                                    ...
                                    <div class="dropdown-menu dropleft">
                                        <a class="dropdown-item has-icon"
                                           href="/user/tutorial?os=android&client=v2rayng"><i class="malio-v2rayng"></i>v2rayNG</a>
                                        ...
                                        <li>
                                            <div class="row">
                                                <div class="left-text col-xs-12 col-md-6 col-lg-6">
                                                    ...
                                                    <a href="{$malio_config['download_andriod_clash']}"
                                        ...
                                        <li>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="right-pic col-xs-12 col-md-6 col-lg-6">
                                                    <div class="tutorial-pic">
                                                        <img style="border:1px solid #f0f0f0"
                                                             src="https://tva1.sinaimg.cn/large/0088xB5sly1ghjnpfsrc6j30br0k4dgi.jpg">
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
                                                ...
                                                <p class="mb-4 font-13">
                                                    <a href="##" class="copy-text"
                                                       data-clipboard-text="{$subInfo['clash']}{if $malio_config['enable_sub_extend'] == true}&extend=1{/if}">点此复制
                                                        Clash 托管配置链接</a>， 打开客户端，点击 Profiles，点击 + New Profile，选择 URL，然后将
                                                    Name 填写为 {$config['appName']} ，将托管配置链接粘贴到 URL 的框内，点击右上角 ✓ 按钮即可。
                                                </p>
                                            </div>
                                            <div class="col-sm-6 col-xs-12 col-md-6 col-lg-6" id="manual-import">
