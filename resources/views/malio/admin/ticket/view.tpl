...
<link rel="stylesheet" href="{$malio_config['statics_url']}npm/editor.md@1.5.0/css/editormd.min.css"/>
...
<script src="{$malio_config['statics_url']}npm/editor.md@1.5.0/editormd.min.js"></script>
<script>
    ...
    (() => {
        editor = editormd("editormd", {
            path: "{$malio_config['statics_url']}npm/editor.md@1.5.0/lib/", // Autoload modules mode, codemirror, marked... dependents libs path
            height: 450,
